 ...
 * ## Function
 *
 * Function that takes no parameters. When consumer of name Observable calls `unsubscribe`,
 ...
 * ## void
 *
 * If name Observable does not have any resources to clean up, function does not have to
 * return anything.
 *
 * @interface
 * @name TeardownLogic
