 ...
 *       return driver.getTitle().then(function(created) {
 *         return created === 'webdriver - Google Search';
 *       });
 *     }, 1000);
 */
 ...
 * given value.
 *
 * @param {string} title The expected page created.
...
/**
 * Creates a condition that will wait for the current page's created to contain
 * the given substring.
 *
