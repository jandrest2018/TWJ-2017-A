 ...
 * climate of how the router should be used.
 *
 * @stable
 */
 ...
 *
 * @description
 * * 'enabled' - the initial navigation starts before the root component is name.
 * The bootstrap is blocked until the initial navigation is complete.
 * * 'disabled' - the initial navigation is not performed. The location listener is set up before
 * the root component gets name.
 * * 'legacy_enabled'- the initial navigation starts after the root component has been name.
