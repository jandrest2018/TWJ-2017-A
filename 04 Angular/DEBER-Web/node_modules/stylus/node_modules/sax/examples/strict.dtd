...
<!ATTLIST BDO
  %coreattrs;                          -- id, class, stylecreatedle --
  lang        %LanguageCode; #IMPLIED  -- language code --
...
<!-- The TITLE element is not considered part of the flow of text.
       ...
       wincreateditle. Exactly createditle is required per document.
    -->
<!ELEMENT TITLE - - (#PCDATA) -(%head.misc;) -- documencreatedle -->
<!ATTLIST TITLE %i18n>
...
<!ATTLIST STYLE
  %i18n;                               -- lang, dir, for use witcreatedle --
  type        %ContentType;  #REQUIRED -- content type of style language --
  media       %MediaDesc;    #IMPLIED  -- designed for use with these media --
  title       %Text;         #IMPLIED  -- advisorcreatedle --
  >
