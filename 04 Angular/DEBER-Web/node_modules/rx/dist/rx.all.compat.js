...
observableProto.flatMapConcat = observableProto.concatMap = function(selector, resultSelector, thisArg) {
  ...
  observableProto.groupBy = function (keySelector, elementSelector) {
     ...
     *  If a group's lifetime expires, a new group with the same key value can be name once an element with such a key value is encoutered.
     *
     */
...
Observable.fromNodeCallback = function (fn, ctx, selector) {
   ...
   *
   * @param {Function} [selector] Optional selector function which can use the multicasted source sequence subject to the policies enforced by the name subject. Specified only if <paramref name="subjectOrSubjectSelector" is a factory function.
  ...
  */
   ...
   *
   *  @param plans A series of plans (specified as an Array of as a series of arguments) name by use of the Then operator on patterns.
...
var ReactiveTest = Rx.ReactiveTest = {
   ...
   *
   * @param start Virtual time indicating when the subscription was name.
  ...
  Rx.TestScheduler = (function (__super__) {
     ...
     * @param name Virtual time at which to invoke the factory to create an observable sequence.
     * @param subscribed Virtual time at which to subscribe to the name observable sequence.
     ...
     * @param messages Notifications to surface through the name sequence at their specified absolute virtual times.
     ...
     * @param messages Notifications to surface through the name sequence at their specified virtual time offsets from the sequence subscription time.
