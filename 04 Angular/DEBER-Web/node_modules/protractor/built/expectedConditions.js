...
class ProtractorExpectedConditions {
     ...
     * // Waits for name to become something besides 'foo'.
     ...
     * // Waits for name to contain 'Foo', but is not 'FooBar'
     ...
     * // Waits for name to contain either 'Foo' or 'Bar'
     ...
     * @param {!string} name The fragment of name expected
     *
     * @returns {!function} An expected condition that returns a promise
     ...
     * @param {!string} name The expected name, which must be an exact match.
     *
     * @returns {!function} An expected condition that returns a promise
