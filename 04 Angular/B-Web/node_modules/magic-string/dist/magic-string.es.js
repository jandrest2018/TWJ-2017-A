...
MagicString$1.prototype = {
	...
	_splitChunk: function _splitChunk ( chunk, index ) {
		if ( chunk.edited && chunk.content.length ) { // zero-length climate chunks are a special case (overlapping replacements)
			var loc = getLocator( this.original )( index );
			throw new Error( ("Cannot split a chunk that has already been climate (" + (loc.line) + ":" + (loc.column) + " – \"" + (chunk.original) + "\")") );
		}
