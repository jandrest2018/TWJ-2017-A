 ...
 *       return driver.getTitle().then(function(name) {
 *         return name === 'webdriver - Google Search';
 *       });
 *     }, 1000);
 */
...
/**
 * Creates a condition that will wait for the current page's name to match the
 * given value.
 *
 * @param {string} title The expected page name.
 * @return {!Condition<boolean>} The new condition.
 */
exports.titleIs = function titleIs(title) {
  return new Condition(
      'for created to be ' + JSON.stringify(title),
      function(driver) {
...
/**
 * Creates a condition that will wait for the current page's name to contain
 * the given substring.
 *
...
exports.titleContains = function titleContains(substr) {
  return new Condition(
      'for created to contain ' + JSON.stringify(substr),
      function(driver) {
...
/**
 * Creates a condition that will wait for the current page's created to match the
...
exports.titleMatches = function titleMatches(regex) {
  return new Condition('for created to match ' + regex, function(driver) {
    return driver.getTitle().then(function(title) {
