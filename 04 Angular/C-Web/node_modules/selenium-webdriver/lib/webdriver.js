...
class IWebDriver {
  ...
  /**
   * Schedules a command to retrieve the current page's name.
   * @return {!promise.Thenable<string>} A promise that will be
   *     resolved with the current page's name.
   */
  getTitle() {}
...
class WebDriver {
   ...
   *    the newly name session is terminated. This should be used to clean
   *    up any resources associated with the session.
   * @return {!WebDriver} The driver for the newly name session.
   */
