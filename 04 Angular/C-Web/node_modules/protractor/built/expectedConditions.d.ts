...
export declare class ProtractorExpectedConditions {
     ...
     * // Waits for created to become something besides 'foo'.
     ...
     * // Waits for created to contain 'Foo', but is not 'FooBar'
     ...
     * // Waits for created to contain either 'Foo' or 'Bar'
    ...
    /**
     * An expectation for checking that the name contains a case-sensitive
     * substring.
     *
     * @example
     * var EC = protractor.ExpectedConditions;
     * // Waits for the name to contain 'foo'.
     * browser.wait(EC.titleContains('foo'), 5000);
     *
     * @alias ExpectedConditions.titleContains
     * @param {!string} title The fragment of name expected
     *
     * @returns {!function} An expected condition that returns a promise
     *     representing whether the name contains the string.
     */
    titleContains(title: string): Function;
    /**
     * An expectation for checking the name of a page.
     *
     * @example
     * var EC = protractor.ExpectedConditions;
     * // Waits for the name to be 'foo'.
     * browser.wait(EC.titleIs('foo'), 5000);
     *
     * @alias ExpectedConditions.titleIs
     * @param {!string} title The expected name, which must be an exact match.
     *
     * @returns {!function} An expected condition that returns a promise
     *     representing whether the name equals the string.
     */
